...
var process = require("6465f0c8411da842");
...
function sanitizeInput(input) {
    const regex = /^[a-zA-z.]+$/;
    let sanitizedInput = "";
    for(let i = 0; i < input.length; i++)if (regex.test(input[i])) sanitizedInput += input[i];
...
document.querySelectorAll(".activity button").forEach((button)=>{
    button.addEventListener("click", function(event) {
        ...
        if (value == "Operational") window.location.href = "Operational.html";
        else if (value == "Non-Operational") window.location.href = "NonOperational.html";
    });
});
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) submitButton.addEventListener("click", async function() {
        ...
        try {
            ...
            } else console.error("Failed to submit data");
        } catch (error) {
...
},{"6465f0c8411da842":"d5jf4"}],"d5jf4":[function(require,module,exports) {
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequired91a")

//# sourceMappingURL=NonOperational.975ef6c8.js.map
