...
})({"2ZGgf":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "171e32a29dbfb3d4";
"use strict";
...
},{}],"hhzyT":[function(require,module,exports) {
var process = require("948016ae580684e5");
...
function showSuggestions(filteredNames) {
    ...
    } else nameList.style.display = "none"; // Hide the dropdown if no matches found
}
...
input.addEventListener("input", async ()=>{
    ...
    } else nameList.style.display = "none"; // Hide the dropdown if input is empty
});
// Hide the dropdown when clicking outside
document.addEventListener("click", (event)=>{
    if (!input.contains(event.target) && !nameList.contains(event.target)) nameList.style.display = "none";
});

},{"948016ae580684e5":"d5jf4"}],"d5jf4":[function(require,module,exports) {
...
},{}]},["2ZGgf","hhzyT"], "hhzyT", "parcelRequired91a")

//# sourceMappingURL=index.9dbfb3d4.js.map
